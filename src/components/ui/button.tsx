    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-emerald-600 text-white hover:bg-emerald-600/90": variant === "default",
            "bg-red-500 text-white hover:bg-red-500/90": variant === "destructive",
            "border border-zinc-800 bg-zinc-950 text-zinc-100 hover:bg-zinc-800 hover:text-zinc-50": variant === "outline",
